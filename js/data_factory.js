...
var countries = {"4":{"name":"Afghanistan","total":"2"},"12":{"name":"Algérie","total":"140"},"24":{"name":"Angola","total":"48"},"51":{"name":"Arménie","total":"1"},"70":{"name":"Bosnie","total":"1"},"108":{"name":"Burundi","total":"39"},"116":{"name":"Cambodge","total":"11"},"120":{"name":"Cameroun","total":"105"},"132":{"name":"Cap Vert","total":"2"},"140":{"name":"Centre Afrique","total":"4"},"148":{"name":"Tchad","total":"5"},"156":{"name":"Chine","total":"3"},"174":{"name":"Comores","total":"7"},"178":{"name":"Congo","total":"78"},"180":{"name":"RDC","total":"64"},"192":{"name":"Cuba","total":"1"},"204":{"name":"Benin","total":"24"},"214":{"name":"Rép. Dominicaine","total":"5"},"231":{"name":"Ethiopie","total":"1"},"262":{"name":"Djibouti","total":"12"},"266":{"name":"Gabon","total":"24"},"270":{"name":"Gambie","total":"2"},"324":{"name":"Guinée","total":"28"},"332":{"name":"Haïti","total":"8"},"356":{"name":"Inde","total":"1"},"368":{"name":"Irak","total":"45"},"384":{"name":"Côte d'Ivoire","total":"49"},"417":{"name":"Kirghistan","total":"3"},"418":{"name":"Laos","total":"160"},"422":{"name":"Liban","total":"1"},"450":{"name":"Madagascar","total":"122"},"466":{"name":"Mali","total":"263"},"478":{"name":"Mauritanie","total":"18"},"496":{"name":"Mongolie","total":"6"},"498":{"name":"Moldavie","total":"113"},"504":{"name":"Maroc","total":"89"},"548":{"name":"Vanuatu","total":"2"},"562":{"name":"Niger","total":"40"},"566":{"name":"Nigeria","total":"2"},"586":{"name":"Pakistan","total":"2"},"642":{"name":"Roumanie","total":"3"},"643":{"name":"Russie","total":"1"},"646":{"name":"Rwanda","total":"3"},"662":{"name":"Sainte-Lucie","total":"1"},"686":{"name":"Sénégal","total":"137"},"694":{"name":"Sierra Léone","total":"1"},"704":{"name":"Vietnam","total":"37"},"716":{"name":"Zimbabwe","total":"1"},"729":{"name":"Soudan","total":"1"},"760":{"name":"Syrie","total":"151"},"762":{"name":"Tadjikistan","total":"1"},"768":{"name":"Togo","total":"6"},"776":{"name":"Tonga","total":"2"},"804":{"name":"Ukraine","total":"12"},"818":{"name":"Egypte","total":"31"},"854":{"name":"Burkina Faso","total":"59"},"860":{"name":"Ouzbekistan","total":"1"},"882":{"name":"Samoa","total":"1"},"887":{"name":"Yemen","total":"3"},"-3":{"name":"Kosovo","total":"2"}};
var countries_mini = {"4":{"name":"Afghanistan","total":"2"}}

var FREEBASE_API_URL = 'https://www.googleapis.com/freebase/v1/search';
var API_KEY = 'AIzaSyDeTSD9Zppyd23wCWkvrr4GhnjzhCCTHIs';

var lookup_country = function(country_name, callback) {
	var lookupParams = {
		'query': country_name,
		'filter': '(all type:/location/country)' ,
		'output': '( /location/country/iso3166_1_alpha2 /location/country/capital /location/country/official_language /location/statistical_region/population /location/statistical_region/gdp_nominal_per_capita)',
		'lang': 'fr',
		'limit': 1,
		'indent': true,
		'spell': 'always',
...
var pop_en_millions = function(pop){
	var n = Number(pop / 1000000).toFixed(1);;
	return n >= 2 ? n + ' millions' : n + ' million'
}

var flag_url = function(iso_code_2){
	return 'http://www.geonames.org/flags/x/' + iso_code_2.toLowerCase() + '.gif';
}

_(countries_mini).each(function(values, code){
	lookup_country(values['name'], function(data){
		var result = data.result[0];
		var iso_code_2 = result.output['/location/country/iso3166_1_alpha2']['/location/country/iso3166_1_alpha2'][0];
		console.log(result);
		...
		new_countries[code] = {
			...
			'flag_url': 'http://www.geonames.org/flags/x/' + iso_code_2.toLowerCase() + '.gif',
			'capitale': _(result.output['/location/country/capital']['/location/country/capital']).last().name,
			'langues': _.map(result.output['/location/country/official_language']['/location/country/official_language'], function(d){return d.name}).join(', '),
			'population_2011': pop_en_millions(result.output['/location/statistical_region/population']['/location/statistical_region/population'][0].value),
		} 
	});
});
